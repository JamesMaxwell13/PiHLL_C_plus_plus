...
void serialize(std::forward_list<std::string>& list, const std::string& filename) {
...
void deserialize(std::forward_list<std::string>& list, const std::string& filename) {
...
int main() {
    ...
    std::forward_list<std::string> list{"aboba", "lol", "kek", "hhhh", "hsdjdh", "kdjhf", "ffffgggggghhhh"};
